...
import responsablesBodegaController from "../controllers/responsable_bodega_controller.mjs";
import inventarioController from "../controllers/inventario_controller.mjs";
import reportesController from "../controllers/reporte_controller.mjs";
...
router.get("/tipoBodegas", tiposBodegaController.obtenerTiposBodega);
router.post("/tipoBodegas", tiposBodegaController.crearTipoBodega);
// Encargado Bodega
router.get(
  "/responsableBodegas",
  responsablesBodegaController.obtenerResponsablesBodega
);
router.post(
  "/responsableBodegas",
  responsablesBodegaController.crearResponsableBodega
);

// Bodega
router.get("/bodegas", bodegaController.obtenerBodegas);
router.post("/bodegas", bodegaController.obtenerBodegas);
router.delete("/bodegas/:id", bodegaController.eliminarBodega); // Eliminar una bodega por su ID
router.put("/bodegas/:id", bodegaController.editarBodega);
...
router.delete("/inventarios/:id", inventarioController.eliminarInventario); // Eliminar un inventario por su ID
router.put("/inventarios/:id", inventarioController.editarInventario);

// Reporte
router.get("/reporte", reportesController.generarReporte);
